                    ...
                    <div class="card-body">
                        ...
                        <table id="table2" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tr>
                                ...
                                <td>{{$item->price}}</td>
                                <td>{{$item->quantity}}</td>
                                <td>{{$item['shop']['shop_name']??'null'}}</td>
                                <td>
                                    <a href="{{route('vendorEditProduct',$item->id)}}" class="btn btn-primary">Edit</a>
                                    <a href="{{route('vendorDeleteProduct',$item->id)}}" class="btn btn-danger">Delete</a>
                                </td>
