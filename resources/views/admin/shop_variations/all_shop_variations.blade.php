                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="table2" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                @foreach ($shopVariations as $key=> $item)
                            ...
                            <tr>
                                ...
                                <td>{{$item['shop']['shop_name']??'shop deleted'}}</td>

                                <td>{{$item->price}}</td>
                                <td>{{$item->quantity}}</td>

                                <td>
                                    <a href="{{route('editShopVariation',$item->id)}}" class="btn btn-primary">Edit</a>
                                    <a href="{{route('deleteShopVariation',$item->id)}}" class="btn btn-danger">Delete</a>
                                </td>
