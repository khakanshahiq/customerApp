            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                      ...
                      <form action="{{route('updateArea',$editArea->id)}}" method="POST">
                        @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="city_name" value="{{$editArea->city_name}}" type="text" placeholder="city name" >
                                @error('city_name')
                    ...
                    {{--end col1  --}}
                     ...
                     <div class="col-md-4">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="area_name" value="{{$editArea->area_name}}"  type="text" placeholder="area name" >
                                @error('area_name')
                    ...
                    <div class="col-md-4">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="post_code" value="{{$editArea->post_code}}"  type="text" placeholder="post code" >
                                @error('post_code')
                    ...
                    {{-- end col2 --}}
                        ...
                        <div class="mb-3">
                            <label>Address</label>
                            <div>
                                <textarea name="address" class="form-control" rows="5">{{$editArea->address}}</textarea>
                            </div>
                            @error('address')
                        ...
                        <div class="mt-5">
                            ...
                            <input class="btn btn-primary float-end" type="submit" value="Update Area">
                        </div>
                    </form>
                    </div>
                </div>
