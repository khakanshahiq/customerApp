                    ...
                    <div class="card-body">
                        ...
                        <table id="table2" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tr>
                                ...
                                <td>{{$item->app_rate}}</td>
                                <td>{{$item->home_delivery_rate}}</td>
                                
                                <td>
                                    <a href="{{route('editRate',$item->id)}}" class="btn btn-primary">Edit</a>
                                    <a href="{{route('deleteRate',$item->id)}}" class="btn btn-danger">Delete</a>
                                </td>
