                ...
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="app_rate" value="{{old('app_rate')}}" type="text" placeholder="app rate" >
                                @error('app_rate')
                    ...
                    <div class="col-md-6">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="home_delivery_rate" value="{{old('home_delivery_rate')}}"  type="text" placeholder="app rate" >
                    ...
                    <div class="row">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="single_item_delivery_rate" value="{{old('single_item_delivery_rate')}}" type="text" placeholder="single item delivery rate" >
                    ...
                    <div class="col-md-6">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="total_delivery_rate" value="{{old('total_delivery_rate')}}"  type="text" placeholder="total order Delivery rate" >
                    ...
                    {{-- end col2 --}}
                        ...
                        <div class="mt-5">
                            ...
                            <input class="btn btn-primary float-end" type="submit" value="Add Rate">
                        </div>
                    </form>
                    </div>
                </div>
