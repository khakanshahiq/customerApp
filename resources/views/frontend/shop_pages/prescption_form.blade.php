                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            @php
                                ...
                                $hasPharmacy = in_array("Pharmacy", $categories);
                                $hasMedicalAid = in_array("Medical Aid", $categories);
                                
                            @endphp
                        
                            @if($hasPharmacy)
                                <h2>Upload Your Prescription</h2><br>
                                <form id="prescription-upload-form" action="{{ route('frontendUploadPrescption') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <label for="prescription">Upload Prescription:</label>
                                        <input type="file" class="form-control" id="prescription" name="prescption_image" accept="image/*">
                                        @error('prescption_image')
